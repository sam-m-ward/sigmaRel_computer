...
SiblingsDistanceSimulator class:
	inputs: Ng=30, Sg = 2, sigma0=0.1, sigmaRel=0.05, mu_bounds = [25,35], sigma_fit_s=0.05
--------------------
...
class SiblingsDistanceSimulator:
    ...
    def __init__(self, Ng=30, Sg = 2, sigma0=0.1, sigmaRel=0.05, mu_bounds = [25,35], sigma_fit_s=0.05):
        """
        Initialisation
        ...
        mu_bounds : list/array of x2 floats, each>0 (optional; default=[25,35])
